...
@router.post("/", response_model=MaintenanceTicketRead, status_code=status.HTTP_201_CREATED)
...
@router.put("/{maintenance_ticket_id}", response_model=MaintenanceTicketRead)
